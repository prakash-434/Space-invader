...
alien=pygame.image.load(r'C:\Users\Dell\Desktop\se\alienfirst.jpg')
...
class Game:
    ...
    def __init__(self, width, height):
        ...
        while not done:
            if len(self.aliens) == 0:
                ...
                self.displayMessage1("NEXT LEVEL:Y ")
            ...
            for alien in self.aliens:
                ...
                if ((alien.y > height-30)or((alien.y+30>hero.y+7)and(alien.x>=hero.x and alien.x<=hero.x+100))):
                    self.screen.fill(WHITE)
                    self.lost = True
    ...
    def displayMessage2(self, text):
        ...
        font = pygame.font.SysFont('comicsansms', 50)
        textsurface = font.render(text, False, RED)
        self.screen.blit(textsurface, (280, 300))
